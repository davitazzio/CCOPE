...
type LinuxProcessService struct {
	Parameters v1alpha1.ProcessParameters
	Logger     logging.Logger
}

var (
	newLinuxProcessService = func(_ []byte, parameters v1alpha1.ProcessParameters, logger logging.Logger) (*LinuxProcessService, error) {
		return &LinuxProcessService{
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(&connector{
			...
			newServiceFn: newLinuxProcessService,
			logger:       o.Logger}),
...
type connector struct {
	...
	newServiceFn func(creds []byte, parameters v1alpha1.ProcessParameters, logger logging.Logger) (*LinuxProcessService, error)
}
...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	process_pid, err := c.service.ObserveLinuxProcess()
	alive := true
	if err != nil {
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	err := c.service.StartLinuxProcess()
...
func (c *external) Delete(ctx context.Context, mg resource.Managed) error {
	...
	err = c.service.KillLinuxProcess(process_pid)
	if err != nil {
